...
/**
 * Binance Spot REST and User Data Stream payloads in the exact shape the API returns them (field names,
 * string-encoded decimals, extra fields the bot ignores), for the WireMock integration tests (issue #103).
 * {@code ${name}} placeholders are filled by {@link #fill}.
 */
final class BinanceFixtures {
    ...
    /** POST /api/v3/order, newOrderRespType=FULL, MARKET BUY filled in two trades: avg 499.8833 / 0.00833 = 60010. */
    ...
    /** GET /api/v3/order of a filled MARKET order; {@code side}, {@code quote} and {@code orderId} vary. */
